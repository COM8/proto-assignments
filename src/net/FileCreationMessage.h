...
class FileCreationMessage : public AbstractMessage
{
  public:
	...
	FileCreationMessage(unsigned int clientId, unsigned int seqNumber, FileType fileType, unsigned char *fileHash, uint64_t fIDLength, unsigned char *fID);
	...
	static FileType getFileTypeFromMessage(unsigned char *buffer);
